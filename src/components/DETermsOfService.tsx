export default function DETermsOfService() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        <article className="bg-white shadow-sm rounded-lg overflow-hidden">
          <header className="bg-white border-b border-gray-200 px-6 py-8 sm:px-8 sm:py-10">
            <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Nutzungsbedingungen</h1>
            <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Willkommen bei 82DASH!</h1>
            <p className="mt-2 text-gray-600">
              Letzte Aktualisierung: <time dateTime="2025-06-01">Juni 2025</time>
            </p>
          </header>
          ...
          <div className="px-6 py-8 sm:px-8 sm:py-10">
            <div className="prose prose-lg prose-gray max-w-none prose-p:text-gray-700 prose-p:leading-relaxed prose-p:mb-6 prose-li:text-gray-700 prose-li:mb-3 prose-li:leading-relaxed prose-strong:text-gray-900 prose-a:text-blue-600 hover:prose-a:text-blue-800 prose-a:no-underline hover:prose-a:underline prose-ul:mb-6 prose-ul:mt-4">
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-4 mt-8 first:mt-0 leading-tight">Einführung</h2>
                <p>
                  Vielen Dank für die Nutzung unserer Plattform sowie der Produkte, Dienstleistungen und Funktionen. Dieses Dokument enthält die Nutzungsbedingungen, die für alle gelten, die auf 82DASH zugreifen oder interagieren, einschließlich Besucher, Nutzer, Creator und Unternehmen („wir“, „uns“ oder „unser“).
                </p>
              </section>
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-4 mt-8 first:mt-0 leading-tight">Unser Dienst</h2>
                <p>
                  82DASH ist eine Plattform, die Marken dabei unterstützt, authentische kundengenerierte Inhalte zu sammeln, zu lizenzieren und zu verwalten.
                  Ob ihr Kampagnen startet, Inhalte hochladet oder mit eurer Community interagiert – 82DASH stellt die Tools und die Infrastruktur bereit, um all das schnell, rechtssicher und mit echter Wirkung umzusetzen.
                </p>
                ...
                <p>
                  Wir wollen einen Unterschied machen – indem wir allen ermöglichen, Inhalte zu erstellen und zu teilen, die schnell, skalierbar und wirkungsvoll sind.
                </p>
              </section>

              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-4 mt-8 first:mt-0 leading-tight">Kontakt</h2>
                <p className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <p>
                      Alles, was ihr über die erlaubte Nutzung von 82DASH wissen müsst – wie ihr die Plattform verwendet, welche Inhalte zulässig sind und wie wir mit Sicherheit und geistigem Eigentum umgehen – ist in diesem Dokument enthalten. Bitte lest es sorgfältig durch.
                    </p>
                    <p>
                  ...
                  <summary className="text-xl font-semibold text-gray-900 cursor-pointer pl-0 list-none">1.3 Zulässige Nutzung der Plattform</summary>
                    <div className="mt-4 space-y-4">
                      ...
                      <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                        ...
                        <li>den Betrieb der Plattform stören oder den Zugriff anderer Nutzer beeinträchtigen</li>
                        <li>Spam versenden, nicht autorisierte Bots einsetzen oder Nutzerdaten ohne Einwilligung sammeln</li>
                        <li>Viren, Malware oder andere schädliche Software hochladen</li>
                      </ul>
                      <p>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <p>
                        Wir respektieren geistige Eigentumsrechte und erwarten dies auch von euch. Durch die Nutzung von 82DASH verpflichtet ihr euch, die Plattform nicht für rechtswidrige oder nicht genehmigte Zwecke zu verwenden, insbesondere nicht zur Verletzung von Schutzrechten Dritter.
                      </p>
                      <p>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                        <li>gegen geltendes Recht oder behördliche Anordnungen verstossen</li>
                        <li>ein rechtliches Risiko für 82DASH oder seine Partner darstellen</li>
                        <li>eine Untersuchung gefährden oder die Integrität der Plattform beeinträchtigen</li>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <p>
                        Obwohl wir uns bemühen, einen reibungslosen Betrieb sicherzustellen, können wir nicht garantieren, dass die Plattform jederzeit verfügbar oder fehlerfrei ist.
                        Wir übernehmen auch keine Verantwortung für Inhalte oder Dienste Dritter, auf die über unsere Plattform zugegriffen wird.
                      </p>
                      <p>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                        <li>Gesetzes- oder Regulierungsänderungen</li>
                        <li>neue Technologien oder Sicherheitsanforderungen</li>
                        <li>Verbesserungen, neue Funktionen oder Änderungen an der Plattform</li>
                        <li>verändertes Nutzerverhalten oder Anforderungen</li>
                        <li>Umstände ausserhalb unserer Kontrolle</li>
                      </ul>
                      <p>
                        Bei wesentlichen Änderungen informieren wir euch mindestens 15 Kalendertage im Voraus (es sei denn, rechtliche oder sicherheitsrelevante Gründe erfordern eine kürzere Frist). Diese Mitteilung enthält eine klare Zusammenfassung der Änderungen sowie Anweisungen, wie ihr Widerspruch einlegen könnt.
                      </p>
                      <p>
                        Wenn ihr 82DASH nach Ablauf dieser Frist ohne Widerspruch weiter nutzt, gilt dies als Zustimmung zu den neuen Bedingungen.
                      </p>
                      <p>
                        Wenn ihr den geänderten Bedingungen nicht zustimmt, könnt ihr vor Inkrafttreten Widerspruch einlegen. Wir teilen euch mit, wie ihr diesen Widerspruch einreichen könnt.
                        Sollte keine Einigung erzielt werden, behalten wir uns vor, euren Zugang gemäss unseren Standardverfahren zu beenden.
                      </p>
                      <p>
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          ...
                          Das Unternehmen ist für sämtliche Aktivitäten verantwortlich, die über sein Konto erfolgen – einschliesslich solcher, die von Mitarbeitenden, Auftragnehmern oder Dritten unter Verwendung dieses Zugangs ausgeführt werden.
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        ...
                        <p>
                          Mit dem Erhalt von Inhalten über 82DASH erhält euer Unternehmen eine nicht-exklusive, unwiderrufliche, unbefristete, gebührenfreie, unterlizenzierbare und weltweite Lizenz zur:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>Nutzung, Vervielfältigung, Bearbeitung, Übersetzung, Darstellung, Verbreitung und Modifikation der eingereichten Inhalte</li>
                          <li>Einbindung der Inhalte in sämtliche kommerziellen und nicht-kommerziellen Materialien, einschliesslich (aber nicht beschränkt auf) Social Media, bezahlte Werbung, Websites, Apps, Produktverpackungen, Printmedien, E-Mail-Kampagnen, Präsentationen und POS-Displays</li>
                        </ul>
                        <p>
                          Eine Namensnennung der Creator oder weitere Genehmigungen sind nicht erforderlich, sofern nicht ausdrücklich anders vereinbart.
                        </p>
                        <p className="italic">
                          Hinweis: Unterlizenzen an Drittpartner, Agenturen, Tochtergesellschaften oder Plattformen sind nur erlaubt, wenn dies durch eine separate schriftliche Vereinbarung zwischen eurem Unternehmen und 82DASH ausdrücklich genehmigt wurde. Ohne eine solche Bestätigung ist eine Unterlizenzierung nicht zulässig.
                        </p>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          82DASH verlangt von allen Beitragenden, dass sie bei der Einreichung von Inhalten bestätigen, dass sie:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>die rechtmässigen Eigentümer der Inhalte sind</li>
                          <li>alle erforderlichen Einwilligungen von identifizierbaren Personen in den Inhalten eingeholt haben</li>
                          <li>die jeweils geltenden gesetzlichen Altersvorgaben erfüllen</li>
                        </ul>
                        <p>
                          82DASH trifft angemessene Vorkehrungen, um sicherzustellen, dass Beitragende diese Voraussetzungen anerkennen, und stellt klare Hinweise zur Verfügung, um ihnen bei der rechtmässigen und autorisierten Einreichung zu helfen. Wir handeln nach bestem Wissen und Gewissen, überprüfen jedoch nicht jede Einreichung einzeln. Daher können wir nicht garantieren, dass sämtliche Inhalte euren spezifischen rechtlichen, regulatorischen oder markenspezifischen Anforderungen entsprechen.
                        </p>
                        <p>
                          Als geschäftlicher Nutzer seid ihr allein dafür verantwortlich zu überprüfen und sicherzustellen, dass alle über die 82DASH‑Plattform lizenzierten Inhalte allen geltenden Gesetzen, Vorschriften und Branchenstandards entsprechen – insbesondere im Bereich Datenschutz, geistiges Eigentum, Werbung und Verbraucherschutz.
                        </p>
                        <p>
                          Durch die Nutzung von lizenzierten Inhalten über 82DASH verpflichtet ihr euch, 82DASH sowie dessen Tochtergesellschaften, Geschäftsführung, Mitarbeitende und Beauftragte von allen Ansprüchen, Haftungen, Schäden, Verlusten und Kosten (einschliesslich angemessener Anwaltskosten) freizustellen und zu verteidigen, die entstehen durch:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>eure Nutzung, Veröffentlichung, Verbreitung oder Bearbeitung der lizenzierten Inhalte</li>
                          <li>jeglichen Verstoss gegen geltendes Recht oder die Verletzung von Rechten Dritter</li>
                          <li>einen Verstoss gegen diese Bedingungen oder eine missbräuchliche Nutzung der Plattform</li>
                        </ul>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          82DASH behält sich das Recht vor, nach eigenem Ermessen Inhalte zu moderieren, einzuschränken oder zu entfernen, die auf der Plattform eingereicht oder über sie verbreitet werden, um geltenden Gesetzen und Vorschriften zu entsprechen.
                        </p>
                        <p>82DASH kann unter anderem folgende Massnahmen ergreifen:</p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>Entfernung oder Sperrung von Inhalten, die als rechtswidrig, rechtsverletzend, irreführend, schädlich, beleidigend, missbräuchlich, pornografisch, nicht einvernehmlich oder plattformwidrig eingestuft werden</li>
                          <li>Sperrung oder Aufhebung des Zugangs zu bestimmten Inhalten bei glaubhafter Mitteilung durch Dritte, Behörden oder durch interne Moderation</li>
                          <li>Benachrichtigung, wenn Inhalte, die ihr lizenziert habt, aus rechtlichen, sicherheitsbezogenen, rufschädigenden oder richtlinienbezogenen Gründen beanstandet oder entfernt wurden – in solchen Fällen kann von euch verlangt werden, jegliche Nutzung und Verbreitung der betroffenen Inhalte sowohl online als auch offline unverzüglich einzustellen</li>
                        </ul>
                        <p>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          Ihr verpflichtet euch, 82DASH sowie dessen Tochterunternehmen, Mitarbeitende, Beauftragte, Auftragnehmer, Geschäftsführung und Verwaltungsrat von sämtlichen Ansprüchen, Schäden, Verlusten, Verbindlichkeiten, Kosten oder Ausgaben (einschliesslich angemessener Anwaltskosten) freizustellen, die sich ergeben aus:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>eurer Nutzung oder missbräuchlichen Nutzung der 82DASH‑Plattform</li>
                          <li>einem Verstoss gegen diese Bedingungen</li>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          Im grösstmöglichen gesetzlich zulässigen Umfang haftet 82DASH – sowie dessen Geschäftsführung, Mitarbeitende, Partner, Beauftragte, Lieferanten und Tochtergesellschaften – nicht für indirekte, zufällige, spezielle, Folgeschäden oder Strafschadensersatz. Dies schliesst unter anderem ein:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>Verlust von Gewinnen, Daten, Nutzungsmöglichkeiten, Goodwill oder anderen immateriellen Werten</li>
                          <li>Unfähigkeit, auf die Plattform zuzugreifen oder sie zu nutzen</li>
                          <li>Unbefugter Zugriff auf unsere Server oder auf darin gespeicherte personenbezogene Daten</li>
                          <li>Übertragung von Viren, Malware oder ähnlichem durch Dritte über unsere Dienste</li>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          Die Nutzung der 82DASH‑Plattform erfolgt auf eigenes Risiko. Die Plattform und alle damit verbundenen Dienste werden ohne jegliche Garantie „wie besehen“ und „wie verfügbar“ bereitgestellt – unabhängig davon, ob ausdrücklich, stillschweigend oder gesetzlich vorgesehen.
                        </p>
                        <p>
                          Soweit gesetzlich zulässig, lehnt 82DASH sämtliche Garantien ab, einschliesslich – aber nicht beschränkt auf:
                        </p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>stillschweigende Garantien der Marktgängigkeit</li>
                          <li>Eignung für einen bestimmten Zweck</li>
                          <li>Nichtverletzung von Rechten</li>
                          <li>jegliche Garantien, die sich aus Handelsbräuchen oder Geschäftsgängen ergeben</li>
                        </ul>
                        <p>82DASH garantiert insbesondere nicht, dass:</p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>die Plattform ununterbrochen, pünktlich, sicher oder fehlerfrei funktioniert</li>
                          <li>Fehler behoben werden</li>
                          <li>die Plattform oder ihre Server frei von Viren, Malware oder anderen schädlichen Komponenten sind</li>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          82DASH erwartet, dass Unternehmen mit Creators stets respektvoll, rechtskonform und professionell umgehen – sowohl auf der Plattform als auch ausserhalb. Dies umfasst sämtliche Kommunikation, Rückmeldungen und Interaktionen im Zusammenhang mit eingereichten Inhalten.
                        </p>
                        <p>
                          Die Kommunikation muss konstruktiv, diskriminierungsfrei und frei von Belästigung, Einschüchterung oder Druck erfolgen – sowohl im privaten als auch im öffentlichen Rahmen.
                        </p>
                        <p>
                          Unternehmen dürfen Creator nicht unter Druck setzen, Inhalte zu ändern, zu löschen oder neu einzureichen, wenn dies den Plattformrichtlinien, geltendem Recht oder den Rechten des Creators widerspricht.
                        </p>
                        <p>
                          Etwaige Konflikte oder Bedenken müssen über die vorgesehenen Kanäle von 82DASH oder gemäss unseren Streitbeilegungsrichtlinien geklärt werden.
                        </p>
                        <p>
                ...
                <div className="mb-4 open">
                  ...
                  <div className="mt-4 space-y-4">
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        <p>
                          Creator müssen kein Nutzerkonto erstellen, um an der 82DASH-Plattform teilzunehmen. Stattdessen können sie Inhalte direkt einreichen, indem sie eine gültige und aktive E-Mail-Adresse angeben, die für die Kommunikation, Verifizierung und Dokumentation verwendet wird.
                        </p>
                        <p>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-3">
                        ...
                        <p>
                          Eine Unterlizenzierung an Dritte ist nur gestattet, wenn dies durch eine separate Vereinbarung zwischen 82DASH und dem anfragenden Unternehmen ausdrücklich genehmigt wurde. Solche Unterlizenzierungen müssen im Voraus bestätigt und dem Creator mitgeteilt werden.
                        </p>
                        <p>
                          Diese Lizenz gilt sowohl für kommerzielle als auch nicht-kommerzielle Zwecke und erfordert keine weitere Mitteilung, Namensnennung oder zusätzliche Zustimmung des Creators, sofern nicht anders angegeben.
                        </p>
                        <p>Mit der Einreichung bestätigen Creator, dass:</p>
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          <li>der Inhalt original, rechtmässig erstellt und frei von Ansprüchen Dritter ist</li>
                          <li>alle erforderlichen Rechte und Einwilligungen (einschliesslich der von erkennbaren Personen) eingeholt wurden</li>
                          <li>der Inhalt ausschliesslich für das anfragende Unternehmen gemäss dieser Lizenz eingereicht wird</li>
                        </ul>

                        <h4 className="font-semibold">3.2.2 Transparenz und Zweck</h4>
                        <p>
                        ...
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          ...
                          <li>aufgrund der Natur digitaler Medien Inhalte nach der Veröffentlichung möglicherweise nicht vollständig aus allen öffentlichen oder Drittanbieter-Systemen entfernt werden können, selbst wenn ein Widerruf versucht wird</li>
                          <li>ein Widerruf oder Rückzug der Einwilligung nach der Einreichung keinen Einfluss auf bereits verwendete, verbreitete oder lizenzierte Inhalte hat</li>
                        </ul>
                        ...
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          ...
                          <li>Alle erkennbaren Personen in den Inhalten haben ihre informierte, ausdrückliche Einwilligung zur Darstellung und zur Nutzung gemäss diesen Bedingungen, einschliesslich kommerzieller Nutzung, erteilt</li>
                          <li>Die Inhalte verletzen keine Rechte Dritter – einschliesslich Urheber- oder Markenrechte, Persönlichkeitsrechte, Veröffentlichungsrechte oder vertragliche Verpflichtungen</li>
                          <li>Die Inhalte entsprechen allen geltenden Gesetzen und Plattformstandards</li>
                        </ul>
                        ...
                        <ul className="space-y-3 mb-6 mt-4 list-disc pl-5">
                          ...
                          <li>aufgrund der digitalen Verbreitung (z. B. auf Social Media-Plattformen, Partnerseiten oder Affiliate-Kanälen) eine vollständige Entfernung von Inhalten möglicherweise nicht mehr möglich ist, und dass Inhalte über den direkten Einflussbereich von 82DASH hinaus zugänglich bleiben können</li>
                          <li>82DASH berechtigte Löschanfragen im Einklang mit geltendem Datenschutzrecht (einschliesslich DSGVO-Betroffenenrechte) berücksichtigt, jedoch bereits unterlizenzierte, geteilte oder öffentlich veröffentlichte Inhalte möglicherweise nicht vollständig aus Systemen Dritter entfernen kann</li>
                        </ul>
                        <p>
                ...
                <div className="mb-4 open">
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <p>
                      Wir hoffen, etwaige Fragen oder Streitigkeiten einvernehmlich lösen zu können, und ermutigen euch, euch zuerst direkt an uns zu wenden, damit wir gemeinsam eine schnelle und faire Lösung finden können.
                    </p>
                    <p>
                      Sollte eine Streitigkeit nicht informell beigelegt werden können, unterliegt sie der ausschliesslichen Zuständigkeit der Gerichte im Vereinigten Königreich – sofern zwischen euch und 82DASH nichts anderes schriftlich vereinbart wurde. Ihr und 82DASH erklärt euch damit einverstanden, euch der alleinigen und ausschliesslichen Zuständigkeit dieser Gerichte zu unterwerfen.
                    </p>
                    <p>
                      Nichts in diesem Abschnitt schränkt zwingende Verbraucherschutzrechte ein, die euch nach dem Recht eures Wohnsitzlandes zustehen.
                    </p>
                    <p className="italic">
